...
# from src.auth.model.user_auth_models import User, Token
...
#         data={"sub": "rfonseca85"}, expires_delta=access_token_expires)
#     return {"access_token": access_token, "token_type": "bearer"}


# @router.get("/users/me/", response_model=User)
# async def read_users_me(current_user: User = Depends(uas.get_current_user)):
#     return current_user
